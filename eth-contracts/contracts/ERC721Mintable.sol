...
contract Ownable {
  ...
  // emptyAddress = address(0)
    ...
    event ownershipTransfer(address currentOwner, address newOwner);
    ...
    function retrieveCurrentOwner() public view returns (address){
         return _owner;
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Address given is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From addrfess is NOT owner of the given token");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "transfer to address is not valid");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // require the token exists before setting
     ...
     function tokenURISet(uint256 tokenId) internal {
           // require the token exists before setting
